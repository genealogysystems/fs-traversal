 ...
 */
FSTraversal.prototype.order = function(type) {
 ...
 * Set the WRD factors.
 */
FSTraversal.prototype.wrd = function(obj) {
 ...
 */
FSTraversal.prototype.filter = function(func) {this._registerCallback('filter', func); return this;};
 ...
 */
FSTraversal.prototype._calcWeight = function(fetchObj) {
  switch(this._options.order) {
    case 'wrd':
      return calcWRD(fetchObj, this._options.wrdFactors);
    case 'ancestry':
 ...
 */
function calcWRD(fetchObj, wrdFactors){
  var wrd = {
    g: 0,
    c: 0,
    m: 0,
  ...
  each(fetchObj.path, function(rel){
    switch(rel.rel) {
      case 'child':
        wrd.g -= 1;
