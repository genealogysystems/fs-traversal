        ...
        if(self._visited[childParent.$getChildId()] 
          ...
          (function(cid, mid, fid) {
            ...
            for(var y in self._callbacks.child) {
              setTimeout(function() {
                self._callbacks.child[y].call(self, self._visited[cid], self._visited[mid], self._visited[fid]);
              }, 0);
            }
          ...
          (function(cid, mid) {
            ...
            for(var y in self._callbacks.parent) {
              setTimeout(function() {
                self._callbacks.parent[y].call(self, self._visited[mid], self._visited[cid]);
              }, 0);
            }
          ...
          (function(cid, fid) {
            ...
            for(var y in self._callbacks.parent) {
              setTimeout(function() {
                self._callbacks.parent[y].call(self, self._visited[fid], self._visited[cid]);
              }, 0);
            }
